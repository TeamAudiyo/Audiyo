...
Good first areas: better error messages, more dataset checks, benchmark reports, docs fixes. Bigger changes need an issue first. Version 0.1.0 stays single runnable model on purpose.
